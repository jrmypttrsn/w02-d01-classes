...
#:name :age :gender :legs :eyes :ears :weapon :depravity :dogs_stolen
  ...
  def test_age_getter
    evil_henchperson = EvilHenchperson.new(name: "Rasputin", age: 47, gender: "male", 
          legs: 4, eyes: 2, ears: 2, shots: true, weapon: "magic", depravity: 83, dogs_stolen: 893)
    assert_equal(47, evil_henchperson.age)
  end
  ...
  def test_depravity_getter
    evil_henchperson = EvilHenchperson.new(name: "Rasputin", age: 47, gender: "male", 
          legs: 4, eyes: 2, ears: 2, shots: true, weapon: "magic", depravity: 83, dogs_stolen: 17)
    assert_equal(83, evil_henchperson.depravity)
  end
  ...
  def test_dogs_stolen_getter
    evil_henchperson = EvilHenchperson.new(name: "Rasputin", age: 47, gender: "male", 
          legs: 4, eyes: 2, ears: 2, shots: true, weapon: "magic", depravity: 83, dogs_stolen: 893)
    assert_equal(893, evil_henchperson.dogs_stolen)
  end

#  def test_eat_another_rabbit
#    evil_henchperson = EvilHenchperson.new(name: "Rasputin", age: 47, gender: "male", 
#         eyes: 2, ears: 2, shots: true weapon: "magic", depravity: 83, dogs_stolen: 893)
#    
